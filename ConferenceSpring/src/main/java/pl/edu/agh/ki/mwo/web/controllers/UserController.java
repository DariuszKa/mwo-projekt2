...
public class UserController{
    ...
    {    	
    	...
    	System.out.println("UserController login='" + login + "' firstName='" + firstName + "' lastName='" + lastName + "' sex='" + sex + "' age=" + age + " university='" + university + "' domain='" + domain + "' email='" + email + "' prelegent=" + prelegent.equals("yes") + " recenzent=" + recenzent.equals("yes") + " admin=" + admin.equals("yes"));
