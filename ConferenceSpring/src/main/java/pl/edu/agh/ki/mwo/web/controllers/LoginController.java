...
public class LoginController {
    ...
    {
    	UserDatabase.getInstance().addUser("jarek", "Zenon", "Przywra", "other", 1962, 5, 22, "PK", "Hardware", "e-mail@domena.com", "Kraków, ul. Czarnowiejska 1", "880321060", true, true, true, "potęga");
